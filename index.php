    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Book",
            "name": "古今悅讀100",
            "image": "https://i.imgur.com/eZJmd8l.jpg",
            "author": {
                "@type": "Person",
                "name": "許婷/黃庭鈺"
            },
            ...
            "review": {
                "@type": "Review",
                "reviewBody": "對閱讀測驗非常有幫助，文言文、白話文、新詩古詩等等都有！而且學測考閱讀的比例真的很高，每天寫一兩回，寫完閱讀能力進步很多！而且文言文也都有翻譯，詳解算蠻好理解的～"
            }
        }
    </script>
...
<body>
    ...
    <center>
        ...
        <div>
            <div id="backdrop">
                <div id="title">
                    ...
                    <a href="query.php" type="button" class="btn btn-lg" style="background-color: #487878; color: white;">開始搜尋</a>
                </div>
            </div>
        </div>
        ...
        <div style="margin: 2%">
            <h3>追蹤我們！</h3>
            <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/CoPqhV7hWa8/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                <div style="padding:16px;">
                    <a href="https://www.instagram.com/p/CoPqhV7hWa8/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank">
            ...
            font-style:normal; font-weight:550; line-height:18px;">在 Instagram 查看這則貼文
                            </div>
                        </div>
                    ...
                    <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; 
        overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                        <a href="https://www.instagram.com/p/CoPqhV7hWa8/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">
                            參考書推薦平台（@study.__.guides）分享的貼文
                        </a>
                    </p>
                </div>
            </blockquote>
